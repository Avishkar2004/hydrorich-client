...
const Cart = () => {
    ...
    const { cart, removeFromCart, clearCart, updateQuantity, syncCart, loading: cartLoading } = useCartStore();

    // Sync cart when component loads and user is authenticated
    useEffect(() => {
        if (user && !cartLoading) {
            syncCart();
        }
                                    ...
                                    <div className="flex-1">
                                        ...
                                        <div className="flex items-center gap-4 mt-4">
                                            <div className="flex items-center border rounded-lg overflow-hidden">
                                                ...
                                                <span className="px-4 py-1 text-gray-800 bg-gray-50">{item.quantity || 0}</span>
                                                <button
